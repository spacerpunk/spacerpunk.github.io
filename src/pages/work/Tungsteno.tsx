    ...
    <div className="p-4">
      ...
      <div>
        ...
        <h3 className="w-full text-sm font-light pt-2 pb-4 text-white">
          ...
          <p className="w-full text-sm font-light pt-2 pb-4">
            It was done 100% in Blender, animated by hand and composited in
            Davinci Resolve. The Sound design was done 100% in Ableton Live.{' '}
          </p>
          <p className="w-full text-sm font-light pt-2 pb-4">
        ...
        <h3 className="w-full text-sm font-light pt-2 pb-4">
          <p className="w-full text-sm font-light pt-2 pb-4">
            The Rift ("La Grieta") is a Short Film about a group of brothers
            escaping from a mysterious and weirdly western villain with a wanted
            special object.{' '}
          </p>
          <p>
            I was involved in all aspects of audio production: In Site
            recording, Re Recording, Sound Design, Editing, Mixing, Writing the
            Original Music and final 5.1 mix.{' '}
          </p>
          <p>
            I was also in this case involved on some of the VFX, like Muzzle
            Flashes, Camera Tracking and 3D Rendering.{' '}
          </p>
          <p className="w-full text-sm font-light pt-2 pb-4">
            Check it out on the official website{' '}
            <a
        ...
        <h2 className="w-full text-normal font-semibold pt-8">
          Abismo - Episode 1 (Pilot)
        </h2>
        <h3 className="w-full text-sm font-light pt-2 pb-4">
          <p className="w-full text-sm font-light pt-2 pb-4">
            Abyss or (Abismo) is the pilot for an 8 Episode Science Fiction
            Series the studio was planing on doing, unfortunately they only did
            the pilot. I was involved in all aspects of audio production: In
            Site recording, Re Recording, Sound Design, Editing, Mixing, Writing
            the Original Music and final 5.1 mix.{' '}
          </p>
          <p className="w-full text-sm font-light pt-2 pb-4">
            Check it out on the official website{' '}
            <a
        ...
        <h3 className="w-full text-sm font-light pt-2 pb-2">
          <p className="w-full text-sm font-light pt-2 pb-4">
            "NO" is a short film that deals with the violent reality of gender
            violence in Argentina. It keeps growing year after year at an
            alarming rate. in less than 24hs this will happen again. I was in
            charge again of the whole audio production, In Set Recording, Re
            Recording, Editing, Mixing, Original Soundtrack and a final 5.1 mix
            to screen on the "Mar del Plata International Film Festival".{' '}
          </p>
          <p className="w-full text-sm font-light pt-2 pb-4">
            Check it out on the official website{' '}
            <a
        ...
        <h2 className="w-full text-normal font-semibold pt-8">
          Los Gloder - Animated Weekly Series
        </h2>
        <h3 className="w-full text-sm font-light pt-2 pb-2">
          <p className="w-full text-sm font-light pt-2 pb-4">
            This was a Weekly Video Game review series done by us. I worked on
            the 2D animation of the characerts, Video Editing, Sound Design and
            Original Music for each week's intro.{' '}
          </p>
        ...
        <h2 className="w-full text-normal font-semibold pt-8">
          Legends "The Home of Football" - Final 5.1 Mix
        </h2>
        <h3 className="w-full text-sm font-light pt-2 pb-2">
          <div className="w-full pb-4 background-gray-800">
          ...
          <p className="w-full text-sm font-light pt-2 pb-4">
            This is an special experience on the Museum of Football in
            Barcelona. I did the final 5.1 mix and Sound Design for it.{' '}
          </p>
          <p className="w-full text-sm font-light pt-2 pb-4">
            Check it out on the official website{' '}
            <a
        ...
        <h3 className="w-full text-sm font-light pt-2 pb-2">
          ...
          <p className="w-full text-sm font-light pt-2 pb-4">
            Social posts for Pringles done 100% in Unreal Engine and Blender.
