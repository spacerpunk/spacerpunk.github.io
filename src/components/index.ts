...
export const DESCRIPTION = `SPACERPUNK is the name I use for every piece of Artistic output I launch into the radiowave void that is our electromagnetic dance of information sharing. Mainly Music and Films, but all forms of Artistic Output are considered.`;
